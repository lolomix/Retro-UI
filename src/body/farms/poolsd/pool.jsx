          ...
          <div className="transaction harvest">
            ...
            <div className="val">
              <span className="amount">
                {(poolInfo.pending / 10 ** props.decimals).toFixed(2)}
              </span>
              <span style={{ fontSize: 13 }} className="value">
                {" "}
                ($
                {(
                  (poolInfo.pending / 10 ** props.decimals) *
                  poolInfo.price
                ).toFixed(2)}
                )
              </span>
            </div>
            <div onClick={()=>{harvest()}} className="btn primary harvest">Harvest</div>
          </div>
        </div>
